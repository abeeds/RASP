...
def test_user_status():
    ...
    assert get_online_status(username), \
        "Expected online status to be True, but got False"

    log_out(username)
    assert not get_online_status(username), \
        "Expected online status to be False, but got True"
